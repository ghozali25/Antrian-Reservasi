  ...
  <footer class="footer mt-auto py-4" style="background-color: #fff;">
    <div class="container">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2024 - <a href="" target="_blank" class="text-danger text-decoration-none">Ahmad Ghozali</a>. All rights reserved.
      </div>
    </div>
  </footer>

  <!-- load file audio bell antrian -->
  <audio id="tingtung" src=".panggilan-antrian/assets/audio/tingtung.mp3"></audio>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        setTimeout(function() {
          responsiveVoice.speak("Nomor Antrian, " + data["no_antrian"] + ", menuju, meja, reservasi", "Indonesian Male", {
            rate: 0.9,
            pitch: 1,
            volume: 1
          });
